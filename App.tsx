...
const App: React.FC = () => {
  ...
  const handleRandomLesson = useCallback(() => {
    ...
    if (allTitles.length > 0) {
      handleGenerateLesson(allTitles[Math.floor(Math.random() * allTitles.length)]);
    }
  ...
  const handleCustomRequest = (e: React.FormEvent) => {
    ...
    handleGenerateLesson(newTopic.title);
    setCustomRequest('');
  };
  ...
  return (
    <div className="min-h-screen pb-20 text-black">
      ...
      <main className="container mx-auto px-4 mt-12 space-y-20">
            ...
            {!isAdminMode && (
              <div className="bg-black text-white p-6 border-4 border-black neo-shadow">
                ...
                <p className="font-bold opacity-90 text-sm mb-4">
                  Discover published topics not yet in the curriculum.
                </p>
                <button
            ...
            {isAdminMode ? (
              ...
              <>
                ...
                <form onSubmit={handleCustomRequest} className="mt-8 flex gap-2">
                  ...
                  <button
                    type="submit"
                    className="bg-black text-[#FF6B00] px-6 border-4 border-black hover:bg-[#FF6B00] hover:text-black transition-all"
                  >
        ...
        {/* Technical Atlas — hidden in admin mode */}
        {!isAdminMode && (
